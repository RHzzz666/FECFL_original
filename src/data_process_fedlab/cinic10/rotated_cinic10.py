...
class RotatedCINIC10(FedDataset):
    """Rotate CINIC10 and patrition them.
    ...
    def preprocess(self, thetas=[0, 180]):
        ...
        print("########### Preprocessing rotated CINIC10 ###########")
        ...
        # plot_label_distribution(self.num, 10, partitions, cinic10_full.targets)
