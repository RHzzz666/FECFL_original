...
class MixFMNIST(FedDataset):
    """MixFMNIST and patrition them.
    ...
    def preprocess(self, thetas=[0, 90, 180, 270, 0, 90, 180, 270]):
        ...
        fmnist_train = torchvision.datasets.FashionMNIST(root=self.root, train=True, download=True)
        fmnist_test = torchvision.datasets.FashionMNIST(root=self.root, train=False, download=True)
        ...
        partitions = pathological_slicing(fmnist_full, self.num, 10, 5)
